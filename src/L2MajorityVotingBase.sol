    ...
    ProposalUpgradeable
{
    ...
    bytes4 internal constant L2_MAJORITY_VOTING_BASE_INTERFACE_ID =
    ...
    /// @notice The struct storing the brige settings
    BridgeDAOSettings private bridgeDAOSettings;
    ...
    /// @param _bridgeDAOSettings The bridge settings.
    function __MajorityVotingBase_init(
        ...
        bridgeDAOSettings = _bridgeDAOSettings;
    }
    ...
    /// @return parentProposalId The ID of the proposal in mainnet.
        ...
        )
    {
        ...
        parentProposalId = proposal_.parentProposalId;
