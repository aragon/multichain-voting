...
contract L1TokenVoting is IMembership, L1MajorityVotingBase {
    ...
    function initialize(
        ...
        __MajorityVotingBase_init(_dao, _votingSettings, _bridgeSettings);
    ...
    function createProposal(
        ...
        bytes memory encodedMessage = abi.encodePacked(proposalId, _startDate, _endDate, _tryEarlyExecution);

        ILayerZeroSender(bridgeSettings.bridge).send({
            _dstChainId: bridgeSettings.chainId,
            _remoteAndLocalAddresses: bytes(""),
